...
// (bcc needed so the daily report can go to multiple recipients without
// them seeing each other). Existing calls to
// sendMail({to, subject, html, headers, attachments}) keep working unchanged.
